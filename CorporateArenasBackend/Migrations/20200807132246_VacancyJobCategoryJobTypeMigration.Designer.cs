...
namespace CorporateArenasBackend.Migrations
{
    ...
    [Migration("20200807132246_VacancyJobCategoryJobTypeMigration")]
    partial class VacancyJobCategoryJobTypeMigration
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CorporateArenasBackend.Data.Models.JobCategory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("CorporateArenasBackend.Data.Models.JobType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("CorporateArenasBackend.Data.Models.Vacancy", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("CorporateArenasBackend.Data.Models.Vacancy", b =>
                {
                    b.HasOne("CorporateArenasBackend.Data.Models.JobCategory", "JobCategory")
                        .WithMany("Vacancies")
                        .HasForeignKey("JobCategoryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("CorporateArenasBackend.Data.Models.JobType", "JobType")
                        .WithMany("Vacancies")
